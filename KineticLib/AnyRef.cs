...
namespace KineticistElementsExpanded.KineticLib
{
    ...
    public class AnyRef : BlueprintReferenceBase
    {
        ...
        public static implicit operator AnyRef(string guid) => guid == null ? null : (AnyRef)new() { deserializedGuid = BlueprintGuid.Parse(guid) };
        public static implicit operator AnyRef(SimpleBlueprint bp) => bp == null ? null : (AnyRef)new() { deserializedGuid = bp.AssetGuid };
